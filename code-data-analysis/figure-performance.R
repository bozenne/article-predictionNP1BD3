...
ggHist2_ccw4 <- ggHist2_ccw4 + geom_col(position = "dodge") + labs(x = "Predicted probability of recovery", y = "proportion of CV predictions", fill = "Observed \n recovery")
...
ggROC_ccw4 <- ggROC_ccw4 + geom_step(aes(y=se,group=interaction(fold,model.lab)),alpha=0.1, size = 1) + geom_abline(slope=1,intercept=0,color = "black")
...
ggHist2_ccw8 <- ggHist2_ccw8 + geom_col(position = "dodge") + labs(x = "Predicted probability of recovery", y = "proportion of CV predictions", fill = "Observed \n recovery")
...
ggROC_ccw8 <- ggROC_ccw8 + geom_step(aes(y=se,group=interaction(fold,model.lab)),alpha=0.1, size = 1) + geom_abline(slope=1,intercept=0,color = "black")
...
ggHist2_ccw12 <- ggHist2_ccw12 + geom_col(position = "dodge") + labs(x = "Predicted probability of recovery", y = "proportion of CV predictions", fill = "Observed \n recovery")
...
ggROC_ccw12 <- ggROC_ccw12 + geom_step(aes(y=se,group=interaction(fold,model.lab)),alpha=0.1, size = 1) + geom_abline(slope=1,intercept=0,color = "black")
...
ggHist2_impw4 <- ggHist2_impw4 + geom_col(position = "dodge") + labs(x = "Predicted probability of recovery", y = "proportion of CV predictions", fill = "Observed \n recovery")
...
dt.CVroc_impw4$model.lab <- factor(dt.CVroc_impw4$model, levels = c("glm0_impw4","glm_impw4","rf_impw4"),
                                   labels = c("logistic model - no biomarkers", "logistic model - biomarkers", "random forest - biomarkers"))
## SANITY CHECK
## ggroc(roc(outcome ~ prediction, data = dt.CVpred_impw4[fold == 3 & model == "glm_impw4"]))
## ggplot(dt.CVroc_impw4[fold==3 & model == "glm_impw4"], aes(x=1-sp,y=se)) + geom_step() + geom_abline(slope=1,intercept=0,color = "black")

ggROC_impw4 <- ggplot(dt.CVroc_impw4,aes(x=1-sp,color=model.lab))
ggROC_impw4 <- ggROC_impw4 + geom_step(aes(y=se,group=interaction(fold,model.lab)),alpha=0.1, size = 1) + geom_abline(slope=1,intercept=0,color = "black")
...
ggHist2_impw8 <- ggHist2_impw8 + geom_col(position = "dodge") + labs(x = "Predicted probability of recovery", y = "proportion of CV predictions", fill = "Observed \n recovery")
...
dt.CVroc_impw8$model.lab <- factor(dt.CVroc_impw8$model, levels = c("glm0_impw8","glm_impw8","rf_impw8"),
                                   labels = c("logistic model - no biomarkers", "logistic model - biomarkers", "random forest - biomarkers"))
## SANITY CHECK
## ggroc(roc(outcome ~ prediction, data = dt.CVpred_impw8[fold == 3 & model == "glm_impw8"]))
## ggplot(dt.CVroc_impw8[fold==3 & model == "glm_impw8"], aes(x=1-sp,y=se)) + geom_step() + geom_abline(slope=1,intercept=0,color = "black")

ggROC_impw8 <- ggplot(dt.CVroc_impw8,aes(x=1-sp,color=model.lab))
ggROC_impw8 <- ggROC_impw8 + geom_step(aes(y=se,group=interaction(fold,model.lab)),alpha=0.1, size = 1) + geom_abline(slope=1,intercept=0,color = "black")
...
dt.CVpred_impw12$model.lab <- factor(dt.CVpred_impw12$model, levels = c("glm0_impw12","glm_impw12","rf_impw12", "rf0_impw12"),
                                    labels = c("logistic model - no biomarkers", "logistic model - biomarkers",
                                               "random forest - biomarkers","random forest - pet only"))
...
ggHist2_impw12 <- ggHist2_impw12 + geom_col(position = "dodge") + labs(x = "Predicted probability of recovery", y = "proportion of CV predictions", fill = "Observed \n recovery")
...
dt.CVroc_impw12$model.lab <- factor(dt.CVroc_impw12$model, levels = c("glm0_impw12","glm_impw12","rf_impw12"),
                                   labels = c("logistic model - no biomarkers", "logistic model - biomarkers", "random forest - biomarkers"))
## SANITY CHECK
## ggroc(roc(outcome ~ prediction, data = dt.CVpred_impw12[fold == 3 & model == "glm_impw12"]))
## ggplot(dt.CVroc_impw12[fold==3 & model == "glm_impw12"], aes(x=1-sp,y=se)) + geom_step() + geom_abline(slope=1,intercept=0,color = "black")

ggROC_impw12 <- ggplot(dt.CVroc_impw12,aes(x=1-sp,color=model.lab))
ggROC_impw12 <- ggROC_impw12 + geom_step(aes(y=se,group=interaction(fold,model.lab)),alpha=0.1, size = 1) + geom_abline(slope=1,intercept=0,color = "black")
...
if(FALSE){
    ...
    ggsave(ggROC_w4, filename = "./figures/ROC-pred-week4.pdf", width = 14)
    ggsave(ggROC_w4, filename = "./figures/ROC-pred-week4.png", width = 14)
    ...
    ggsave(ggROC_w8, filename = "./figures/ROC-pred-week8.pdf", width = 14)
    ggsave(ggROC_w8, filename = "./figures/ROC-pred-week8.png", width = 14)
    ...
    ggsave(ggROC_w12, filename = "./figures/ROC-pred-week12.pdf", width = 14)
    ggsave(ggROC_w12, filename = "./figures/ROC-pred-week12.png", width = 14)
