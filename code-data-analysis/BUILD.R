...
## Version: 
## Last-Updated: apr 22 2022 (15:48) 
##           By: Brice Ozenne
##     Update #: 13
##----------------------------------------------------------------------
## 
...
Udir <- c("perf-cc-traj-perm" = "analysis-predictionCC-traj",
          "perf-cc-week12-perm" = "analysis-predictionCC-w12", 
          "perf-cc-week4-perm" = "analysis-predictionCC-w4",  
          "perf-cc-week8-perm" = "analysis-predictionCC-w8",  
          "perf-imp-traj-perm" = "analysis-predictionNA-traj",
          "perf-imp-week12-perm" = "analysis-predictionNA-w12", 
          "perf-imp-week4-perm" = "analysis-predictionNA-w4", 
          "perf-imp-week8-perm" = "analysis-predictionNA-w8"
          )  
...
for(iDir in 1:length(Udir)){ ## iDir <- 4
    ...
    if(length(iVec.files.perm)>0){
        ...
        if(all(sapply(iRes.estimate[-1],identical,iRes.estimate[[1]]))){
            ...
            stop("Mismatch between point estimates ",Udir[iDir],". \n")
        }
